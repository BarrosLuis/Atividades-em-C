...
struct funcionario {
    // Estrutura com os dados que serão pedidos para cadastrar o funcionário
    int matricula;
    char nome[30];
    char cargo[15];
};
...
int main(){
    ...
    do{
        // Menu inicial com as instruções para o usuário
        ...
        // Switch para o usuário selecionar as opções oferecidas
...
// Função de cadastrar funcionários
int resp;
...
void salvar_cadastro(FUNC funcionario){
    // Função sem retorno que salva os funcionários cadastrados
...
void exibir_func(){
    ...
    // Função sem retorno que exibe os funcionários cadastrados
